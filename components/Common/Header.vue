            ...
            <div class="text-gray-400 mt-[1px]" tabindex="-1">
                <Transition name="fade" mode="out-in">
                    <div v-if="$route.path === '/'" key="title" class="eric">
                        <svg width="197" height="150" viewBox="0 0 197 150" fill="none" :key="colorMode.preference"
                            ...
                            <path
                                ...
                                :stroke="colorMode.preference === 'dark' ? '#FED7AA' : '#18181b'" stroke-width="6.5"
                                stroke-linejoin="round" />
                            <path d="M143.5 93.5C141.905 96.4507 141.957 98.0915 143.5 101"
                                :stroke="colorMode.preference === 'dark' ? '#FED7AA' : '#18181b'" stroke-width="4.5"
                                stroke-linejoin="round" />
                            <path d="M194.5 130C193.193 132.929 193.074 134.571 194.5 137.5"
                                :stroke="colorMode.preference === 'dark' ? '#FED7AA' : '#18181b'" stroke-width="4.5"
                                stroke-linejoin="round" />
                        </svg>
                    </div>
